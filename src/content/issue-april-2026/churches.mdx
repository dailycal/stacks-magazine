...
<ArticleImage images={[{ src: image1, alt: "Vertical photo" }, { src: image2, alt: "Vertical photo" }]} caption="Photos by Joe Noriega" />
...
<ArticleImage images={[{ src: image3, alt: "Vertical photo" }, { src: image4, alt: "Vertical photo" }]} caption="Photo by Anjali Butte" />
...
<ArticleImage images={[{ src: image5, alt: "Vertical photo" }, { src: image6, alt: "Vertical photo" }]} caption="Photo by Anjali Butte" />
...
<ArticleImage images={[{ src: image7, alt: "Vertical photo" }, { src: image8, alt: "Vertical photo" }]} />

<ArticleImage images={[{ src: image9, alt: "Vertical photo" }, { src: image10, alt: "Vertical photo" }]} columns={2} caption="Photos by Joe Noriega" />
